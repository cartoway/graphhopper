 ...
 * @author Karl Hübner
 */
public class MatrixFootTagParser extends VehicleTagParser {
    static final int SLOW_SPEED = 2;
    static final int MEAN_SPEED = 5;
    // larger value required - ferries are faster than pedestrians
    static final int FERRY_SPEED = 5;
    ...
    public MatrixFootTagParser(EncodedValueLookup lookup, PMap properties) {
        this(
                lookup.getBooleanEncodedValue(VehicleAccess.key(properties.getString("name", "matrixfoot"))),
                lookup.getDecimalEncodedValue(VehicleSpeed.key(properties.getString("name", "matrixfoot"))),
                lookup.getDecimalEncodedValue(VehiclePriority.key(properties.getString("name", "matrixfoot"))),
    ...
    protected MatrixFootTagParser(BooleanEncodedValue accessEnc, DecimalEncodedValue speedEnc, DecimalEncodedValue priorityEnc,
